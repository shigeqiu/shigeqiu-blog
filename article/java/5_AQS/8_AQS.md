...
- [从ReentrantLock的实现看AQS的原理及应用](#%e4%bb%8ereentrantlock%e7%9a%84%e5%ae%9e%e7%8e%b0%e7%9c%8baqs%e7%9a%84%e5%8e%9f%e7%90%86%e5%8f%8a%e5%ba%94%e7%94%a8)
  - [前言](#%e5%89%8d%e8%a8%80)
  - [1 ReentrantLock](#1-reentrantlock)
    - [1.1 ReentrantLock特性概览](#11-reentrantlock%e7%89%b9%e6%80%a7%e6%a6%82%e8%a7%88)
    - [1.2 ReentrantLock与AQS的关联](#12-reentrantlock%e4%b8%8eaqs%e7%9a%84%e5%85%b3%e8%81%94)
  - [2 AQS](#2-aqs)
    - [2.1 原理概览](#21-%e5%8e%9f%e7%90%86%e6%a6%82%e8%a7%88)
      - [2.1.1 AQS数据结构](#211-aqs%e6%95%b0%e6%8d%ae%e7%bb%93%e6%9e%84)
    - [2.1.2 同步状态State](#212-%e5%90%8c%e6%ad%a5%e7%8a%b6%e6%80%81state)
    - [2.2 AQS重要方法与ReentrantLock的关联](#22-aqs%e9%87%8d%e8%a6%81%e6%96%b9%e6%b3%95%e4%b8%8ereentrantlock%e7%9a%84%e5%85%b3%e8%81%94)
    - [2.3 通过ReentrantLock理解AQS](#23-%e9%80%9a%e8%bf%87reentrantlock%e7%90%86%e8%a7%a3aqs)
    - [2.3.1 线程加入等待队列](#231-%e7%ba%bf%e7%a8%8b%e5%8a%a0%e5%85%a5%e7%ad%89%e5%be%85%e9%98%9f%e5%88%97)
      - [2.3.1.1 加入队列的时机](#2311-%e5%8a%a0%e5%85%a5%e9%98%9f%e5%88%97%e7%9a%84%e6%97%b6%e6%9c%ba)
      - [2.3.1.2 如何加入队列](#2312-%e5%a6%82%e4%bd%95%e5%8a%a0%e5%85%a5%e9%98%9f%e5%88%97)
      - [2.3.1.3 等待队列中线程出队列时机](#2313-%e7%ad%89%e5%be%85%e9%98%9f%e5%88%97%e4%b8%ad%e7%ba%bf%e7%a8%8b%e5%87%ba%e9%98%9f%e5%88%97%e6%97%b6%e6%9c%ba)
    - [2.3.2 CANCELLED状态节点生成](#232-cancelled%e7%8a%b6%e6%80%81%e8%8a%82%e7%82%b9%e7%94%9f%e6%88%90)
    - [2.3.3 如何解锁](#233-%e5%a6%82%e4%bd%95%e8%a7%a3%e9%94%81)
    - [2.3.4 中断恢复后的执行流程](#234-%e4%b8%ad%e6%96%ad%e6%81%a2%e5%a4%8d%e5%90%8e%e7%9a%84%e6%89%a7%e8%a1%8c%e6%b5%81%e7%a8%8b)
    - [2.3.5 小结](#235-%e5%b0%8f%e7%bb%93)
  - [3 AQS应用](#3-aqs%e5%ba%94%e7%94%a8)
    - [3.1 ReentrantLock的可重入应用](#31-reentrantlock%e7%9a%84%e5%8f%af%e9%87%8d%e5%85%a5%e5%ba%94%e7%94%a8)
  - [3.2 JUC中的应用场景](#32-juc%e4%b8%ad%e7%9a%84%e5%ba%94%e7%94%a8%e5%9c%ba%e6%99%af)
  - [3.3 自定义同步工具](#33-%e8%87%aa%e5%ae%9a%e4%b9%89%e5%90%8c%e6%ad%a5%e5%b7%a5%e5%85%b7)
...
Java中的大部分同步类（`Lock`、`Semaphore`、`ReentrantLock`等）都是基于`AbstractQueuedSynchronize`r（简称为AQS）实现的。AQS是一种提供了原子式管理同步状态、阻塞和唤醒线程功能以及队列模型的简单框架。本文会从应用层逐渐深入到原理层，并通过ReentrantLock的基本特性和ReentrantLock与AQS的关联，来深入解读AQS相关独占锁的知识点，同时采取问答的模式来帮助大家理解AQS。由于篇幅原因，本篇文章主要阐述AQS中独占锁的逻辑和Sync Queue，不讲述包含共享锁和Condition Queue的部分（本篇文章核心为AQS原理剖析，只是简单介绍了ReentrantLock，感兴趣同学可以阅读一下ReentrantLock的源码）。
...
节点入队不是原子操作，所以会出现短暂的 `head != tail` ，此时Tail指向最后一个节点，而且Tail指向Head。如果Head没有指向Tail（可见5、6、7行），这种情况下也需要将相关线程加入队列中。所以这块代码是为了解决极端情况下的并发问题。
...
欢迎加入美团Java技术交流群，跟作者零距离交流。如想进群，请加美美同学的微信（微信号：MTDPtech03），回复：AQS，美美会自动拉你进群。