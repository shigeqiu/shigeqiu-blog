...
- [Leaf-来自美团点评的分布式ID生成系统](#leaf-来自美团点评的分布式id生成系统)
    - [背景介绍](#背景介绍)
    - [常见方法介绍](#常见方法介绍)
        - [UUID](#uuid)
        - [类snowflake方案](#类snowflake方案)
        - [数据库生成](#数据库生成)
    - [Leaf 方案实现](#leaf-方案实现)
    - [Leaf-segment数据库方案](#leaf-segment数据库方案)
        - [双buffer优化](#双buffer优化)
        - [Leaf高可用容灾](#leaf高可用容灾)
    - [Leaf-snowflake方案](#leaf-snowflake方案)
        - [弱依赖ZooKeeper](#弱依赖zookeeper)
        - [解决时钟问题](#解决时钟问题)
    - [Leaf现状](#leaf现状)
    - [作者介绍](#作者介绍)
...
![](../../img/分布式系统/Leaf-来自美团点评的分布式ID生成系统/20181130172603.jpg)
...
![](../../img/分布式系统/Leaf-来自美团点评的分布式ID生成系统/20181130174409.jpg)
...
![](../../img/分布式系统/Leaf-来自美团点评的分布式ID生成系统/20181130174721.jpg)
...
![](../../img/分布式系统/Leaf-来自美团点评的分布式ID生成系统/20181130175200.jpg)
...
![](../../img/分布式系统/Leaf-来自美团点评的分布式ID生成系统/20181130175448.jpg)
...
![](../../img/分布式系统/Leaf-来自美团点评的分布式ID生成系统/20181130180052.jpg)
...
![](../../img/分布式系统/Leaf-来自美团点评的分布式ID生成系统/20181130180320.jpg)
...
![](../../img/分布式系统/Leaf-来自美团点评的分布式ID生成系统/20181130180516.jpg)
...
![](../../img/分布式系统/Leaf-来自美团点评的分布式ID生成系统/20181130180703.jpg)
...
![](../../img/分布式系统/Leaf-来自美团点评的分布式ID生成系统/20181130181101.jpg)

参见上图整个启动流程图，服务启动时首先检查自己是否写过ZooKeeper leaf_forever节点：

1. 若写过，则用自身系统时间与leaf_forever/${self}节点记录时间做比较，若小于leaf_forever/${self}时间则认为机器时间发生了大步长回拨，服务启动失败并报警。
1. 若未写过，证明是新服务节点，直接创建持久节点leaf_forever/${self}并写入自身系统时间，接下来综合对比其余Leaf节点的系统时间来判断自身系统时间是否准确，具体做法是取leaf_temporary下的所有临时节点(所有运行中的Leaf-snowflake节点)的服务IP：Port，然后通过RPC请求得到所有节点的系统时间，计算sum(time)/nodeSize。
1. 若abs( 系统时间-sum(time)/nodeSize ) < 阈值，认为当前系统时间准确，正常启动服务，同时写临时节点leaf_temporary/${self} 维持租约。
...
![](../../img/分布式系统/Leaf-来自美团点评的分布式ID生成系统/20181130181305.jpg)
